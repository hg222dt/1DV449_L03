...
var TRIN = TRIN || {};
	...
	TRIN.initialize = function() {
			...
			var myLatlng2 = new google.maps.LatLng(62.88722932,19.91876062);
	...
	TRIN.addMarker = function(map, myLatlng) {
...
// google.maps.event.addDomListener(window, 'load', TRIN.initialize);
